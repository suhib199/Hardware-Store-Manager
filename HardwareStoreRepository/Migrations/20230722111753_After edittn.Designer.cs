...
namespace HardwareStoreRepository.Migrations
{
    ...
    [Migration("20230722111753_After edittn")]
    partial class Afteredittn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HardwareStoreRepository.Models.Login", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HardwareStoreRepository.Models.Login", b =>
                {
                    b.HasOne("HardwareStoreRepository.Models.User", "User")
                        .WithOne("Login")
                        .HasForeignKey("HardwareStoreRepository.Models.Login", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
